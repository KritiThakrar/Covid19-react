...
const Worldtable =() => {
    ...
    useEffect(()=>{
        fetch("https://covid--19-livetracker.herokuapp.com/covid_data_world/get_data_table")
            ...
            <div className="row">
                <div className="col">
                    <div className="mt-5 col mr-5">
                        <p className="text-center mr-5 pr-5">Search your country name</p>
                    </div>
                    ...
                    <div className="col">
                        <Worlddatatable data={search(data)} />
                    </div>
                </div>
            </div>
        </div>
